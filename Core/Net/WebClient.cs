...
namespace Core.Net
{
	...
	public class WebClient : IDisposable
	{
		...
		/// 内部WebRequest对象
		/// </summary>
		public WebRequest request { get { return this._req; } }

		/// <summary>
		/// 内容WebResponse对象
		/// </summary>
		public WebResponse response { get { return this._resp; } }
		...
		/// 已发送或下载数据字节大小
		/// </summary>
		public long recived { get { return this._recived; } }
		...
		/// </summary>
		public int outType { get { return this._outType; } }

		/// <summary>
		/// 当前状态
		/// </summary>
		public WebClientState state { get { return this._state; } }

		/// <summary>
		/// 指示是否已结束下载（一般用于异步模式）
		/// </summary>
		public bool isDone { get { return ( this._state == WebClientState.Finished || this._state == WebClientState.Error ); } }
		...
		/// 下载的文本内容（一般用于异步模式）
		/// </summary>
		public string text { get { return this.GetText(); } }
